...
import com.myspider.core.crawlColletor.webcollector.crawler.AutoParseCrawler;
...
public abstract class BreadthCrawler extends AutoParseCrawler {
    ...
    public void setDbManager(String dbManagerPath){
          this.dbManager = new BerkeleyDBManager(dbManagerPath);
    }
}
