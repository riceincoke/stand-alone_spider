...
import com.myspider.core.crawlColletor.webcollector.crawler.Crawler;
...
public class BerkeleyCrawler extends Crawler {
    ...
    public BerkeleyCrawler(String crawlPath, Executor executor) {
        super(new BerkeleyDBManager(crawlPath), executor);
    }
