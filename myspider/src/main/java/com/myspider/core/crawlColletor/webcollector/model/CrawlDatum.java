 ...
 */
package com.myspider.core.crawlColletor.webcollector.model;
...
public class CrawlDatum implements Serializable, MetaGetter, MetaSetter<CrawlDatum> {
    ...
    public final static int STATUS_DB_UNEXECUTED = 0;//未爬取
    public final static int STATUS_DB_FAILED = 1;//爬取失败
    public final static int STATUS_DB_SUCCESS = 5;//爬取成功

    private String url = null;//任务链接
    private long executeTime = System.currentTimeMillis();//系统时间

    //private int httpCode = -1;
    private int status = STATUS_DB_UNEXECUTED;//未爬去状态
    private int executeCount = 0;//爬取数量
    /**
     ...
     */
    private JsonObject metaData = new JsonObject();// json存入元数据
